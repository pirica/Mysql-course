...
[⬅ Back to Course Home](../README.md) · [Set 1](set-01-easy-basics.md) · [Set 3](set-03-window-functions-and-first-rows.md) · [Set 4](set-04-advanced-windows-and-conditional-logic.md) · [Set 5](set-05-strings-regex-and-set-operations.md) · [Interview Problem Sets](../interview-questions/) · [LeetCode SQL 50 study plan ↗](https://leetcode.com/studyplan/top-sql-50/)
